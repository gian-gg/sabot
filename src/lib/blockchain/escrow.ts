...
export async function createBlockchainEscrow(
    ...
    if (ethAmount && (deliverableType === DeliverableType.Crypto || deliverableType === DeliverableType.Hybrid)) {
 ...
 * @param escrowId - The blockchain escrow ID
 */
export async function confirmBlockchainEscrow(escrowId: number): Promise<string> {
    const contract = await getContract();
 ...
 * @param escrowId - The blockchain escrow ID
 */
export async function raiseBlockchainDispute(escrowId: number): Promise<string> {
    const contract = await getContract();
 ...
 * @param escrowId - The blockchain escrow ID
 */
export async function approveBlockchainArbiter(escrowId: number): Promise<string> {
    const contract = await getContract();
 ...
 * @param escrowId - The blockchain escrow ID
 */
export async function cancelBlockchainEscrow(escrowId: number): Promise<string> {
    const contract = await getContract();
 ...
 * @param escrowId - The blockchain escrow ID
 */
export async function handleExpiredBlockchainEscrow(escrowId: number): Promise<string> {
    const contract = await getContract();
 ...
 * @param escrowId - The blockchain escrow ID
 */
export async function getBlockchainEscrow(escrowId: number): Promise<BlockchainEscrowData> {
 ...
 * @param agreementId - The on-chain agreement ID
 */
export async function getEscrowsForAgreement(agreementId: number): Promise<number[]> {
    const contract = await getContractReadOnly();
...
export async function listenToEscrowEvents(
    eventName: 'EscrowCreated' | 'EscrowJoined' | 'EscrowConfirmed' | 'EscrowReleased' | 'EscrowDisputed' | 'ArbiterProposed' | 'ArbiterApproved' | 'ArbiterActivated' | 'EscrowResolved' | 'EscrowCancelled' | 'ProofSubmitted',
